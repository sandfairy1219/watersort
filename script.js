document.addEventListener('DOMContentLoaded', () => {
    ...
    function pourWater(fromBottle, toBottle) {
        const fromWaters = Array.from(fromBottle.querySelectorAll('.water'));
        const toWaters = Array.from(toBottle.querySelectorAll('.water'));
        ...
        for (let i = 0; i < moveCount; i++) {
            const water = fromBottle.querySelector('.water:last-child');
